                ...
                if (!TextUtils.isEmpty(message)) {
                    switch (messageType.getCheckedRadioButtonId()) {
                        ...
                        case R.id.radio_send:
                            ...
                            sd.setPhoto(ContextCompat.getDrawable(MultiListActivity.this, R.drawable.han1));
                            mAdapter.add(sd);
                            break;
                        ...
                        case R.id.radio_receive:
                            ...
                            rd.setPhoto(ContextCompat.getDrawable(MultiListActivity.this, R.drawable.han3));
                            mAdapter.add(rd);
                            break;
