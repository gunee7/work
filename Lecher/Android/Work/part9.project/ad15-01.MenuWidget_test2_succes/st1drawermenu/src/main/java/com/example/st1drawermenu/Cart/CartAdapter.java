...
public class CartAdapter extends ArrayAdapter< CartModel >{
    ...
    public CartAdapter(@NonNull Context context, int resource, @NonNull List<CartModel> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        holder.coffeeName   .setText          (this.getItem(position).getCoffeeName() );
        holder.coffePrice   .setText          (this.getItem(position).getCoffePrice() );
        holder.coffeeCount  .setText          (this.getItem(position).getCoffeeCount());
