...
public class Tab4_Adapter_Card extends ArrayAdapter<Tab4_Model_Card> {
    ...
    public Tab4_Adapter_Card(@NonNull Context context, int resource, @NonNull List<Tab4_Model_Card> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        inflaterView = inflater.inflate( R.layout.fragment_tab4_custom, parent , false );
