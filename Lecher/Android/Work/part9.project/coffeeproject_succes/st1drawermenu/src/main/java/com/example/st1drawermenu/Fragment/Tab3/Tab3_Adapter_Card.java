...
public class Tab3_Adapter_Card extends ArrayAdapter<Tab3_Model_Card> {
    ...
    public Tab3_Adapter_Card(@NonNull Context context, int resource, @NonNull List<Tab3_Model_Card> objects) {
